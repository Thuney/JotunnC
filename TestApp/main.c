...
void window1_run(struct window_t* window)
{
    ...
    struct renderer_2d_t* renderer = &window->metadata.renderer_2d;
...
int main(int argc, char** argv)
{
    ...
    window1_ptr->metadata.function_custom_window_run = &window1_run;
    // window2_ptr->metadata.function_custom_window_run = &window2_run;
