...
extern void platform_vertex_attribute_init(
  ...
  void* ptr_offset_to_attrib)
{
  ...
  platform_vertex_attribute_init(
    vertex_attribute,
    index,
    size,
    data_type,
