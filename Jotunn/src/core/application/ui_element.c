                                     ...
                                     struct ui_theme_t* theme)
{
    ...
    const fvector3 line_point2 = 
        (fvector3) 
        {
            origin_position.comp.x + ui_element->width + ui_element->padding_x - slider_margin,
            origin_position.comp.y - ((ui_element->height / 2) + ui_element->padding_y),
            0.2f
        };
    ...
    const fvector3 slider_point1 = 
        (fvector3)
        {
            ...
            origin_position.comp.y - ((ui_element->height / 2) + ui_element->padding_y) + slider_margin,
            0.3f
        };
