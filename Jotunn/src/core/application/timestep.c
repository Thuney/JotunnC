  ...
  struct timestep_t* timestep)
{
  ...
  timestep->current_time_seconds =
    diff_timespec(&timestep->current_time, &timestep->start_time);
  timestep->delta_time_seconds =
    diff_timespec(&timestep->current_time, &timestep->last_time);
}
